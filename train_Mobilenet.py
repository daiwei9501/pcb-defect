...
def _main():
    ...
    val_path = 'model_data/val.txt'
    log_dir = 'logs/yolov3_mobilenet/'
    ...
    if is_tiny_version:
        ...
        model = create_model(input_shape, anchors, num_classes, load_pretrained=False,
                             weights_path='logs/yolov3_mobilenet/trained_weights_final.h5', freeze_body=2) # make sure you know what you freeze
    ...
    val_split = 0.1
    #np.random.seed(None)
    num_val = int(len(t_lines) * val_split) # 拿出0.1做val集
